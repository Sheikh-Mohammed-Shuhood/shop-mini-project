...
<div>
    ...
    <div class="container-sm col-sm-5 mt-md-3" >
        ...
        <button onclick="location.href = 'updateproduct.html'" class="btn btn-outline-success m-3">
            Update Product Info
        ...
        <button onclick="location.href = 'deleteproduct.php'" class="btn btn-outline-success m-3">
            Delete Product
            <div class="arrow-wrapper">
                <div class="arrow"></div>
    ...
    <?php
        ...
        if(isset($_POST["search"])){
            ...
            echo "<tbody>";
            // Fetch data from the database
            $sql = "SELECT * FROM product WHERE PRODNAME='$_POST[searchstr]' ";
            $result = $conn->query($sql);
            // Loop through each row of data
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
